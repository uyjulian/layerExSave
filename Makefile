...
CFLAGS += -Wall -Wno-unused-value -Wno-format -fpermissive -I. -I.. -I../ncbind -ILodePNG -DGIT_TAG=L\"$(GIT_TAG)\" -DNDEBUG -DWIN32 -D_WIN32 -D_WINDOWS 
...
SOURCES := ../tp_stub.cpp ../ncbind/ncbind.cpp Main.cpp savepng.cpp savetlg5.cpp tlg5/slide.cpp LodePNG/lodepng.cpp utils.cpp  ../zlib/adler32.c ../zlib/compress.c ../zlib/crc32.c ../zlib/deflate.c ../zlib/trees.c ../zlib/zutil.c
OBJECTS := $(SOURCES:.c=.o)
